  ...
  <div class="login">
    ...
    <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <div style="display: flex;justify-content: space-between">
        ...
        <el-button @click="handleDialogValue()" type="info" plain >没有账户？点我注册</el-button>
      </div>
<!--      <a>没有账户？点我注册</a>@click="handleDialogValue()"-->
    ...
    <div class="el-login-footer">
      <span>汽车租赁管理系统 <a href="#" target="_blank"></a> </span>
    </div>
  </div>
  <Dialog v-model="dialogVisible" :dialogVisible="dialogVisible" :dialogTitle="dialogTitle"></Dialog>
</template>
